...
public class GuillotineState extends GameState {
    ...
    /**
     * This method initiates all of the action cards ands places them into the deck unshuffled
     * @param: None
     *
     * @return: This method does not return anything.
     */
     ...
     * @param: None
     *
     * @return always return false bec they have to checked by another method.
     */
    ...
    /**
     * This method lets the user skip to play action card, if they want to.
     *
     * @param: None.
     *
     * @return always return false because it has to be checked by another method.
